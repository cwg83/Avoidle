...
function insertLetter(pressed) {
  ...
  if (parent_slot.parent().attr('class') != undefined) {
	...
	if ($(".clicked")[0]) {
		...
		if (isLetter) {
			$('.clicked').append(pressed)
			$('.clicked').attr('data-state', 'filled')
			if (guessed_letters.indexOf(pressed.toUpperCase()) != -1) {
				clicked_tile.addClass("already-guessed")
			}
